...
from app.SQL.sql import fetch_users
...
@form_router.callback_query(F.data == "mailing")
async def mailing(callback: types.CallbackQuery):
    await callback.answer('Вы перешли во вкладку рассылка')
...
@form_router.message(Mailing.photo)
